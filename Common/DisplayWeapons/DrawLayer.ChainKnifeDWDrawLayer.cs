...
namespace ScourgeMod.Common.DisplayWeapons
{
    public class ChainKnifeDWDrawLayer : PlayerDrawLayer
    {
        ...
        public override bool GetDefaultVisibility(PlayerDrawSet drawInfo) =>
            DWHelper.GetDefaultVisibility(drawInfo) && DWRegistry.IsDW_ChainKnife(drawInfo);
        ...
        private Vector2 GetPosition(PlayerDrawSet drawInfo)
        {
            ...
            DWAdjust_ChainGuillotines.TryAdjustPosition(drawInfo, ref position);
        ...
        private float GetScale(PlayerDrawSet drawInfo)
        {
            ...
            DWAdjust_ChainGuillotines.TryAdjustScale(drawInfo, ref defaultScale);
