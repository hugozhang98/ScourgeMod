namespace ScourgeMod.Common.BackWeapons
{
    public class BackSwordDrawLayer //: PlayerDrawLayer
    {
        ...
        //private Vector2 GetOrigin(Rectangle frame, Player player) => frame.Size() * 0.5f;
        ...
        //    //默认偏移
        //    position += new Vector2(0f, player.gravDir * -3f);
        ...
        //    float moveSway = DWHelper.GetMoveSway(player, 5f);
